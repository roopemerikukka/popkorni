  ...
  return (
    <Container>
      <TextWrap>
        ...
        <p>Lauluyhtye Popkorni on vuonna 2021 kuorolaisten itsensä perustama kupliva popkuoro suoraan Helsingin Pasilasta. Popkornin soundia ja suuntaa valmentaa laulupedagogi <a href="https://www.annijarvio.com/">Anni Järviö</a>.</p>
